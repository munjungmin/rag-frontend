  ...
  return (
    <div className="p-8">
      <div className="max-w-2xl mx-auto text-center">
        <h3 className="text-xl font-medium text-gray-800 mb-2">Chunking</h3>
        <p className="text-gray-500 mb-6">Creating semantic chunks</p>

        <div className="mb-6 bg-green-50 border border-green-200 rounded-xl p-4">
          <h4 className="font-medium text-green-600 mb-3">Chunking Results</h4>
